  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Plantilla Semanal</h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Define los horarios base para cada día de la semana. Esta plantilla se puede aplicar a rangos de fechas específicos.
        </p>
      </div>
